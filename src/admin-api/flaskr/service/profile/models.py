...
class UserProfile(db.Model):
    ...
    profile_type = Column(Integer, nullable=False, default=0, comment='0 default, 1 system configuration, 2 user configuration, 3 course configuration')
    ...
    status = Column(Integer, nullable=False, default=0, comment='0 for deleted, 1 for active')
