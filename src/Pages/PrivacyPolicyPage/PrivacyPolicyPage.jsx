...
以下协议详细介绍了北京潺潺山木科技有限公司公司（以下简称“我们”）会如何通过 枕头: Python教练（以下简称“本产品”） 收集、使用、共享、存储和保护您的个人信息以及您可以如何管理您的个人信息，在您开始使用我们的产品和服务前，请您务必先仔细阅读和理解本政策，确保您充分理解和同意后再开始使用。
...
您有权修改、查询、复制您的个人信息或者将您的个人信息转移至其他指定信息处理者。在符合相关法律法规并核实确认您的用户身份的前提下，您可以通过 support@xxxx.com 向我们提出具体处理需求，我们将在15个工作日内予以反馈。

#### 信息删除

在符合相关法律法规并核实确认您的用户身份的前提下，您可以向我们提出信息删除需求。 您可以删除您账户的问答历史，通过点击【历史会话-删除操作】，即可执行此类操作。

在以下情形中，您可以向我们提出删除个人信息的请求，您可以通过【support@xxxx.com】随时与我们联系：
...
如您在使用本产品时对协议有任何问题，可通过发送邮件至 support@zhentou.ai 或通过本产品意见反馈渠道或网站上标识的方式与我们联系。
`;
