...
以下协议详细介绍了xxxx公司（以下简称“我们”）会如何通过 枕头编程私教（以下简称“本产品”） 收集、使用、共享、存储和保护您的个人信息以及您可以如何管理您的个人信息，在您开始使用我们的产品和服务前，请您务必先仔细阅读和理解本政策，确保您充分理解和同意后再开始使用。
...
如您在使用本产品时对协议有任何问题，可通过发送邮件至 support@xxxx.com 或通过本产品意见反馈渠道或网站上标识的方式与我们联系。
`;
