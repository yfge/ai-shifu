    ...
    <Card className={isDialog ? "border-0 shadow-none" : ""}>
          ...
          <TabsContent value="phone" className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                ...
                />
                <Button onClick={handleSendOtp} disabled={isLoading || showOtpInput}>
          ...
          <TabsContent value="password" className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" className="p-0 h-auto text-primary text-sm" onClick={handleForgotPassword}>
                  忘记密码?
                </Button>
              </div>
              <Input
      ...
      <CardFooter className="flex flex-col items-center space-y-2">
        <p className="text-sm text-muted-foreground">
          还没有账号?{" "}
          <Button variant="link" className="p-0 h-auto text-primary" onClick={handleRegister}>
            立即注册
          </Button>
        </p>
        <p className="text-sm text-muted-foreground">
