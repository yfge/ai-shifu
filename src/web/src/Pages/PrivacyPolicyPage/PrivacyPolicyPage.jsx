...
const markdown = `# 《用户隐私协议》

## 用户隐私协议

以下协议详细介绍了北京潺潺山木科技有限公司公司（以下简称“我们”）会如何通过 哎！师傅（以下简称“本产品”） 收集、使用、共享、存储和保护您的个人信息以及您可以如何管理您的个人信息，在您开始使用我们的产品和服务前，请您务必先仔细阅读和理解本政策，确保您充分理解和同意后再开始使用。
