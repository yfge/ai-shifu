...
def test_pingxx_order(app):
    ...
    order = create_pingxx_order(app, order_no, pingxx_id, 'wx_pub_qr', 100, 
                                client_ip="127.0.0.1" ,subject= "AI编程助手",body="AI编程助手", 
...
def test_pingxx_ali_order(app):
    ...
    order = create_pingxx_order(app, order_no, pingxx_id, 'alipay_pc_direct', 100, 
                                client_ip="123.122.95.34" ,subject= "AI",body="AI",
                                # extra=dict({})
                                extra=dict({})
                                )
    
    print(order)
    order = create_pingxx_order(app, order_no, pingxx_id, 'alipay_qr', 100, 
                                client_ip="123.122.95.34" ,subject= "AI",body="AI",
                                extra=dict({})
