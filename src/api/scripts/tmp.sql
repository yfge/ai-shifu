...
) ENGINE=InnoDB AUTO_INCREMENT=5870 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `classroom_online_count` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46461 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8047 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-07 11:19:59
 ...
 alter table user_info add user_state int not null default 0 comment 'user state';


 create table `user_conversion` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
  `user_id` char(36) NOT NULL DEFAULT '' COMMENT 'User UUID',
  `conversion_id` char(36) NOT NULL DEFAULT '' COMMENT 'Conversion UUID',
  `conversion_source` int NOT NULL DEFAULT '0' COMMENT 'Conversion type',
  `conversion_status` int NOT NULL DEFAULT '0' COMMENT 'Conversion state',
  `conversion_uuid` char(36) NOT NULL DEFAULT '' COMMENT 'Conversion UUID',
  `conversion_third_platform` varchar(255) NOT NULL DEFAULT '' COMMENT 'Conversion third platform',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
  `updated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
  PRIMARY KEY (`id`),
  KEY `idx_user_id_user_conversion` (`user_id`),
